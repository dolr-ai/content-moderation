...
class Phi35Model:
    def __init__(
        ...
        """Initialize the Phi-3.5 model and tokenizer.
...
class Phi35ContentModerator:
    ...
    def __init__(self, model: Phi35Model = None):
        """Initialize the content moderator with a Phi35Model instance."""
        self.model = model or Phi35Model()
